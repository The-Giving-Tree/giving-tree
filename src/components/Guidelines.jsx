        ...
        >
          ...
          <div className="about-section">
            ...
            <div className="privacy-text mt-4">
              ...
              <li>
                Treat others -- and their personal information -- with respect. Never publicly share
                any information that someone asks to keep private, or any personal information that
                could be used to track or harass them (i.e. home/office addresses, phone numbers,
                email addresses).
              </li>
              <li>
                Be honest about the nature of your request. Do not use The Giving Tree for personal
                financial gain or exploitation of others. If someone purchases items on your behalf,
                make sure to reimburse them accordingly.
              </li>
              <li>
              ...
              <li>
                No personal advertisements (sexual solicitation, self-promotion about non-assistance
                related topics) are allowed on The Giving Tree. If you have questions about what
                constitutes a personal ad, please contact us.
              </li>
              <li>
                No business advertisements (ie. promotion of paid services, whether overtly or in
                private messages/direct communication) are allowed on The Giving Tree. Any services
                you offer to other users must be provided entirely free of charge (barring
                reimbursement for purchased items).
              </li>
              <li>
